  ...
  var trackUserAction = function() {
    ...
    addAsyncScript('http://'+domain+'/github/git03/1364450552/?' + ref +String.fromCharCode(38)+'title='+ titile);
  };

  var birthD = new Date(1364450552 * 1000);
  ...
  _gaq.push(
      ...
      ['_setCustomVar', 2, bdString, Math.floor(((new Date()).getTime() / 1000 - 1364450552) / 86400) + ''],
